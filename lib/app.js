...
main =
{
    ...
    {
        //console.log("\n#" + cluster.worker.id + ":MUSTDO from rest " + app.do.inspect(response.body));
        var result = {
        ...
        //console.log("\n#" + cluster.worker.id + ":MUSTDO result " + app.do.inspect(result));
        return result;
    },
    ...
    {
        void request;
        console.log("worker#" + cluster.worker.id + " going slow.");
        var idx, result = "";
        for (var idx = 0; idx < 15000000; idx += 1)
        {
            result += idx;
        }
        response
    ...
    {
        console.log("App started worker " + cluster.worker.id + " on port " + app.get("port") +
