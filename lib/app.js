...
app.do =
{
    ...
    respondWithLocation: function (request, response)
    {
        ...
        rest.get("http://ip-api.com/json/" + iplist)
            ...
            .end(function (subResponse) {
                app.do.handleLookupResponse(iplist, response, subResponse);
            });

/*

    var loc = rest.get("http://ip-api.com/json")
            .header('Accept', 'application/json')
            .end(function () {
                response.json({
 ...
 sample responses from service
 http://ip-api.com/json/google
 {
